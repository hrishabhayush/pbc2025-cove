...
contract CoveTest is Test {
    ...
    uint256 constant FLIGHT_ID = 100;
    ...
    function setUp() public {
        ...
        coveAsset.mint(saddress(PROVIDER), suint256(1000 ether)); 
        coveAsset.mint(saddress(PASSENGER), suint256(100 ether));
    }
    ...
    function test_PolicyPurchaseFlow() public {
        ...
        // Verify policy state
        (,,,address buyer,,bool isPurchased) = cove.policies(suint256(POLICY_ID));
